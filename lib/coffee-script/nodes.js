...
(function() {
  ...
  exports.Uses = Uses = (function(_super) {
    var $private;

    __extends(Uses, _super);

    $private = '$Uses_';

    function Uses(variable, parent, body, uses) {
