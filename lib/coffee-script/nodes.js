...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Enumeration, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Include, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Namespace, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, last, merge, multident, some, starts, unfoldSoak, utility, _ref, _ref1;
  var __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; 
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.privatizeNode = function(o) {
      var expression, i, p, prefix, x, _i, _j, _len, _len1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _results;
      _ref2 = this.expressions;
      _results = [];
      for (i = _i = 0, _len = _ref2.length; _i < _len; i = ++_i) {
        expression = _ref2[i];
        if (expression != null ? (_ref3 = expression.body) != null ? _ref3.classBody : void 0 : void 0) {
          x = (_ref4 = o.scope.expressions.expressions) != null ? (_ref5 = _ref4[i]) != null ? _ref5.variable : void 0 : void 0;
          if (((x != null ? x.properties : void 0) != null) && ((x != null ? (_ref6 = x.base) != null ? _ref6.value : void 0 : void 0) != null)) {
            prefix = '$' + x.base.value;
            _ref7 = x.properties;
            for (_j = 0, _len1 = _ref7.length; _j < _len1; _j++) {
              p = _ref7[_j];
              if ((p != null ? (_ref8 = p.name) != null ? _ref8.value : void 0 : void 0) != null) {
                prefix += '_' + p.name.value;
              }
            }
            _results.push(this.r(prefix, expression));
          } else {
    ...
    Block.prototype.r = function(prefix, node) {
      var key, value, _results;
      _results = [];
      for (key in node) {
        value = node[key];
        if (typeof value === 'object' || typeof value === 'array') {
          _results.push(this.r(prefix, value));
        } else if (key === 'value') {
          if ((value != null ? value.substr(0, 1) : void 0) === '_' && value !== '_super') {
            _results.push(node[key] = prefix + value);
          } else {
            _results.push(void 0);
          }
        } else {
    ...
    Block.prototype.privatizeExps = function(prefix, exps) {
      var exp, param, r2, _i, _len, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _results;
      _results = [];
      for (_i = 0, _len = exps.length; _i < _len; _i++) {
        exp = exps[_i];
        if (((_ref2 = exp.args) != null ? (_ref3 = _ref2[0]) != null ? (_ref4 = _ref3.body) != null ? _ref4.expressions : void 0 : void 0 : void 0) != null) {
          r2 = exp.args[0].body.expressions;
          this.privatizeExps(prefix, r2);
        }
        param = null;
        if (exp.variable != null) {
          param = (_ref5 = exp.variable.properties) != null ? (_ref6 = _ref5[0]) != null ? _ref6.name : void 0 : void 0;
        } else {
          param = (_ref7 = exp.properties) != null ? (_ref8 = _ref7[0]) != null ? _ref8.name : void 0 : void 0;
        }
        _results.push(this.privatizeParam(prefix, param));
      }
      return _results;
    };

    Block.prototype.privatizeNodeR = function(prefix, xxx) {
      var exps, p, _i, _len, _ref2, _results;
      _results = [];
      for (_i = 0, _len = xxx.length; _i < _len; _i++) {
        p = xxx[_i];
        if ((_ref2 = p.value) != null ? _ref2.body : void 0) {
          exps = p.value.body.expressions;
          _results.push(this.privatizeExps(prefix, exps));
        } else {
          _results.push(void 0);
        }
      }
    ...
    Block.prototype.privatizeParam = function(prefix, param) {
      if (param) {
        if (param.value.substr(0, 1) === '_') {
          return param.value = prefix + param.value;
        }
      }
    };
    ...
    Block.prototype.compileRoot = function(o) {
      var aliases, code, comparator, exp, i, idt, inc, includes, includesJs, k, p, prelude, preludeExps, providesJs, providesUniq, rest, v, _i, _len, _ref2;
      o.indent = o.bare ? '' : TAB;
      ...
      if (o.goog) {
        providesUniq = {};
        _ref2 = o.goog.provides;
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          p = _ref2[_i];
          providesUniq[p] = "goog.provide('" + p + "');\n";
        }
        for (k in providesUniq) {
          v = providesUniq[k];
          providesJs += v;
        }
        ...
        aliases = (function() {
          ...
          for (_j = 0, _len1 = aliases.length; _j < _len1; _j++) {
            inc = aliases[_j];
            _results.push("" + o.indent + "var " + inc.alias.value + " = " + inc.name + ";");
          }
          return _results;
        })();
    ...
    Block.prototype.compileWithDeclarations = function(o) {
      var assigns, code, declars, exp, i, name, noTypeVars, post, rest, scope, spaced, typeName, _i, _j, _len, _len1, _ref2, _ref3, _ref4, _ref5, _ref6;
      code = post = '';
      _ref2 = this.expressions;
      for (i = _i = 0, _len = _ref2.length; _i < _len; i = ++_i) {
        exp = _ref2[i];
      ...
      if (scope.expressions === this) {
        ...
        if (i && (declars || assigns)) {
          code += '\n';
        }
        if (declars) {
          noTypeVars = [];
          _ref5 = scope.declaredVariables();
          for (_j = 0, _len1 = _ref5.length; _j < _len1; _j++) {
            name = _ref5[_j];
            if (typeName = (_ref6 = scope.typeAnnotation(name)) != null ? _ref6.value : void 0) {
              code += "" + this.tab + "/** @type {" + typeName + "} */\n";
  ...
  exports.Class = Class = (function(_super) {
    ...
    function Class(variable, parent, body, uses) {
      this.variable = variable;
      this.parent = parent;
      this.body = body != null ? body : new Block;
      this.uses = uses != null ? uses : null;
      this.boundFuncs = [];
      this.body.classBody = true;
    }

    Class.prototype.children = ['variable', 'parent', 'body', 'mixin'];
    ...
    Class.prototype.compileNode = function(o) {
      var call, decl, klass, lname, name, p, params, prefix, u, usesArg, _i, _len, _ref2, _ref3, _ref4;
      ...
      if (decl) {
        prefix = '$' + this.variable.base.value;
        _ref2 = this.variable.properties;
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          p = _ref2[_i];
          if ((p != null ? (_ref3 = p.name) != null ? _ref3.value : void 0 : void 0) != null) {
            prefix += '_' + p.name.value;
          }
        }
        this.body.expressions.unshift(new Assign(new Value(new Literal('$private')), new Literal("'" + prefix + "_'")));
      }
      ...
      if (this.uses) {
        usesArg = new Value(new Literal(((function() {
          var _j, _len1, _ref5, _results;
          _ref5 = this.uses;
          _results = [];
          for (_j = 0, _len1 = _ref5.length; _j < _len1; _j++) {
            u = _ref5[_j];
            _results.push(u.flatten());
          }
          return _results;
        }).call(this)).join(', ')));
        this.body.expressions.unshift(new Call(new Value(new Literal(utility('uses'))), [lname, usesArg]));
      }
      if (this.parent) {
      ...
      if (o.goog) {
        o.goog.provides.push(this.variable.compile(o));
      }
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      var isValue, match, name, ta, val, varBase, _ref2, _ref3, _ref4, _ref5;
      ...
      if (!this.context) {
        ...
        if (!(typeof varBase.hasProperties === "function" ? varBase.hasProperties() : void 0)) {
          ...
          if (ta = this.variable.typeAnnotation) {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, i, idt, lit, name, p, param, params, parentClassName, ref, splats, uniqs, val, wasEmpty, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      if (this.ctorParent && o.goog) {
        parentClassName = this.ctorParent.compile(o);
        o.goog.includes.push({
  ...
  exports.Op = Op = (function(_super) {
    var $private, CONVERSIONS, INVERSIONS;
  ...
  exports.Enumeration = Enumeration = (function(_super) {
    var $private;

    __extends(Enumeration, _super);

    $private = '$Enumeration_';

    function Enumeration(namespace, definition) {
      this.namespace = namespace;
      this.definition = definition != null ? definition : null;
    }

    Enumeration.prototype.compileNode = function(o) {
      var ns, prop, props, propsJs, _i, _len, _ref2;
      ns = this.namespace.flatten();
      if (o.goog) {
        o.goog.provides.push(ns);
      }
      props = [];
      _ref2 = this.definition.expressions[0].base.properties;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        prop = _ref2[_i];
        if (prop.variable) {
          props.push("" + o.indent + this.tab + prop.variable.base.value + ": " + prop.value.base.value);
        }
      }
      if (props) {
        propsJs = props.join(",\n");
  ...
  exports.Include = Include = (function(_super) {
    ...
    Include.prototype.isStatement = YES;
  ...
  exports.Namespace = Namespace = (function(_super) {
    var $private;
    ...
    Namespace.prototype.isStatement = YES;
  ...
  UTILITIES = {
    "extends": function() {
      return "function(child, parent) { for (var key in parent) { if (" + (utility('hasProp')) + ".call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; \n   child.superClass_ = parent.prototype; // google closure\n   return child; \n}";
    },
    uses: function() {
