...
(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.addImplicitParentheses = function() {
      ...
      condition = function(token, i) {
        ...
        if (tag === 'IF' || tag === 'ELSE' || tag === 'CATCH' || tag === '->' || tag === '=>' || tag === 'CLASS' || tag === 'ENUMERATION') {
          seenSingle = true;
        }
        ...
        return !token.generated && this.tag(i - 1) !== ',' && (__indexOf.call(IMPLICIT_END, tag) >= 0 || (tag === 'INDENT' && !seenControl)) && (tag !== 'INDENT' || (((_ref = this.tag(i - 2)) !== 'CLASS' && _ref !== 'EXTENDS' && _ref !== 'IMPLEMENTS' && _ref !== 'ENUMERATION') && (_ref1 = this.tag(i - 1), __indexOf.call(IMPLICIT_BLOCK, _ref1) < 0) && !((post = this.tokens[i + 1]) && post.generated && post[0] === '{')));
      };
      action = function(token, i) {
      ...
      return this.scanTokens(function(token, i, tokens) {
        ...
        tag = token[0];
        if (tag === 'CLASS' || tag === 'IF' || tag === 'FOR' || tag === 'WHILE' || tag === 'ENUMERATION') {
          noCall = true;
        }
  ...
  IMPLICIT_CALL = ['IDENTIFIER', 'NUMBER', 'STRING', 'JS', 'REGEX', 'NEW', 'PARAM_START', 'CLASS', 'ENUMERATION', 'IF', 'TRY', 'SWITCH', 'THIS', 'BOOL', 'UNARY', 'SUPER', '@', '->', '=>', '[', '(', '{', '--', '++'];
